...
'log'      u (column(0)):6 t 'Mean Obj_f'       w l ls 1, \
'log'      u (column(0)):7 t 'Best Ever Obj_f'  w l ls 1, \
'log2'     u (column(0)):5 t '2Best Obj_f'      w l ls 2, \
'log2'     u (column(0)):6 t '2Mean Obj_f'      w l ls 2, \
'log2'     u (column(0)):7 t '2Best Ever Obj_f' w l ls 2, \
'log3'     u (column(0)):5 t '3Best Obj_f'      w l ls 3, \
'log3'     u (column(0)):6 t '3Mean Obj_f'      w l ls 3, \
'log3'     u (column(0)):7 t '3Best Ever Obj_f' w l ls 3, \
