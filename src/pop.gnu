...
plot \
'log'      u (column(0)):1 t 'Best Fitness'   w l ls 1, \
'log'      u (column(0)):2 t 'Best Fitness'   w l ls 1, \
'log'      u (column(0)):3 t 'Best Fitness'   w l ls 1, \
'log'      u (column(0)):4 t 'Best Fitness'   w l ls 1, \
'log'      u (column(0)):5 t 'Best Fitness'   w l ls 1, \
'log'      u (column(0)):6 t 'Best Fitness'   w l ls 1, \
'log'      u (column(0)):7 t 'Best Fitness'   w l ls 1, \
'log'      u (column(0)):9 t 'Best Fitness'   w l ls 1, \
